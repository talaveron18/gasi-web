...
export default function Chatbot(){
 ...
 return <>
  ...
  {isOpen&&<div role="dialog" aria-modal="false" aria-label="Asistente de información y contacto GASI" className="fixed bottom-6 right-6 z-50 w-[min(420px,calc(100vw-2rem))] h-[min(640px,calc(100vh-2rem))] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden">
