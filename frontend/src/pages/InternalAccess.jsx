...
export default function InternalAccess(){
 ...
 const submit=async e=>{e.preventDefault();if(await signIn(workerId.trim(),password))navigate('/interno/prototipo-clinico');};
