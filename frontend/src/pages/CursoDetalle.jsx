                ...
                <CardContent className="p-6">
                  <div className="text-center mb-6">
                    {course.is_free ? (
                      ...
                      <div>
                        <span className="text-4xl font-bold text-[#005EB8]">{course.price}€</span>
                        <span className="text-gray-500 ml-2">/ curso</span>
                      </div>
                    )}
                  </div>
                  
                  <Button 
                    className="w-full bg-[#005EB8] hover:bg-[#004a92] text-white py-6 text-lg"
                    ...
                    <Card key={module.module_id || index} className="border-l-4 border-l-[#005EB8]">
                      <CardContent className="p-5">
                        <div className="flex items-start gap-4">
                          <div className="w-10 h-10 bg-[#005EB8] text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">
                            {index + 1}
                          </div>
                          <div>
                ...
                <Card className="bg-gray-50">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-gray-600">
                      El contenido detallado del curso se proporcionará durante la formación.
                    </p>
                    <p className="text-gray-500 text-sm mt-2">
                      Contacte con nosotros para más información sobre el programa.
                    </p>
                  </CardContent>
                </Card>
              )}
            ...
            <div className="lg:col-span-1">
              ...
              <Card className="bg-[#F8FAFC]">
                <CardContent className="p-6 space-y-6">
                  <div>
                    <div className="flex items-center gap-2 text-[#005EB8] mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Personal de empresas, responsables de prevención, trabajadores designados</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Diploma acreditativo de GASI</p>
                  </div>
                </CardContent>
              </Card>
              
              <div className="mt-6">
                <Card className="bg-[#005EB8] text-white">
                  <CardContent className="p-6 text-center">
                    <Calendar className="w-8 h-8 mx-auto mb-3" />
                    <h3 className="font-semibold mb-2">¿Necesitas otra fecha?</h3>
                    <p className="text-sm text-white/80 mb-4">
                      Organizamos formación a medida para tu empresa
                    </p>
                    <Link to="/contacto">
                      <Button variant="outline" className="bg-transparent border-white text-white hover:bg-white hover:text-[#005EB8]">
                        Contactar
                      </Button>
                    </Link>
                  </CardContent>
      ...
      <section className="py-16 bg-[#F8FAFC]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 mb-8">
            Inscríbete ahora y mejora las capacidades de respuesta ante emergencias de tu equipo
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg"
              className="bg-[#005EB8] hover:bg-[#004a92] text-white"
              onClick={handleEnroll}
            >
